...
// const secretKey = 'mySecretKey'; // Secret key
// const hmac = crypto.createHmac('sha256', secretKey); // Create an HMAC
// hmac.update('Hello, World!'); // Update with data
// const hmacDigest = hmac.digest('hex'); // Get the digest
